# Módulo JavaScript Pt 2 - DevClub	
...
- 2 *Escreva um programa onde, você chama uma função enviando um número (aceitar somente valores entre 1 e 10)* e escreva *a tabuada de 1 a 10 do valor lido.*
...
- 5 *Escreva um programa onde, você chame uma função mandando 2 argumentos, 2 números, e a função responde qual número é maior.*
...
- 8 Escreva um programa onde, você cria uma função geradora de desconto. A função aceita 4 parâmetros (Nome do cliente, valor total da compra, um booleano que diz se é a primeira compra do cliente ou não, um booleando que diz se o cliente vai pagar a vista ou não)
  ...
  - Confesso que esse último exercício foi bem desafiador, mas foi muito legal de resolver.

  ### Os exercícios de Map, Filter e Reduce, não tinham nenhuma regra, mas alguns eu montei o meu próprio array e tentei resolver conforme as orientações do Rodolfo Mori, conforme o andamento do módulo.
